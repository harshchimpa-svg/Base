        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GymCategories_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserMembership_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMembership_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShopSetting_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShopSetting_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GymProductId = table.Column<int>(type: "integer", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_GymProducts_GymProductId",
                        column: x => x.GymProductId,
                        principalTable: "GymProducts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CartItems_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductDocuments_GymProducts_GymProductId",
                        column: x => x.GymProductId,
                        principalTable: "GymProducts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductDocuments_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleProduct_GymProducts_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GymDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GymDocuments_Gyms_GymId",
                        column: x => x.GymId,
                        principalTable: "Gyms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GymDocuments_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GymTrainers_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_GymProductId",
                table: "CartItems",
                column: "GymProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_OrganizationId",
                table: "CartItems",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GymCategories_OrganizationId",
                table: "GymCategories",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_GymDocuments_GymId",
                table: "GymDocuments",
                column: "GymId");

            migrationBuilder.CreateIndex(
                name: "IX_GymDocuments_OrganizationId",
                table: "GymDocuments",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GymTrainers_OrganizationId",
                table: "GymTrainers",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDocuments_GymProductId",
                table: "ProductDocuments",
                column: "GymProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductDocuments_OrganizationId",
                table: "ProductDocuments",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopSetting_EmployeeId",
                table: "ShopSetting",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopSetting_OrganizationId",
                table: "ShopSetting",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMembership_OrganizationId",
