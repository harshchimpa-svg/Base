...
namespace Persistence.Migrations
{
    ...
    [Migration("20260311032030_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.GymCartItem.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.GymCategories.GymCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.GymMemberships.UserMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.GymProducts.GymProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.GymTrainers.GymTrainer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.PaymentLogs.PaymentLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.ShopSettings.ShopSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.GymProducts.GymProduct", b =>
                {
                    b.HasOne("Domain.Entities.GymCategories.GymCategory", "GymCategory")
                        .WithMany()
                        .HasForeignKey("GymCategoryId");
            ...
            modelBuilder.Entity("Domain.Entities.SaleProducts.SaleProduct", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.GymProducts.GymProduct", "Product")
                        .WithMany()
