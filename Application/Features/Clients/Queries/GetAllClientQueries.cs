...
public class GetAllClientQueries: IRequest<Result<List<GetClientsDto>>>
{
}
internal class GetAllClientsQueriesHandler : IRequestHandler<GetAllClientQueries, Result<List<GetClientsDto>>>
{
    ...
    public async Task<Result<List<GetClientsDto>>> Handle(GetAllClientQueries request, CancellationToken cancellationToken)
    {
