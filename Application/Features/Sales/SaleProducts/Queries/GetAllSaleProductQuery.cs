...
public class GetAllSaleProductQuery: IRequest<PaginatedResult<GetSaleProductDto>>
{
    public int? SaleId { get; set; }
    public int PageNumber { get; set; }
    public int PageSize { get; set; }
}
internal class GetAllSaleProductQueryHandler : IRequestHandler<GetAllSaleProductQuery,PaginatedResult<GetSaleProductDto>>
{
    private readonly IMapper _mapper;
    private readonly IUnitOfWork _unitOfWork;

    public GetAllSaleProductQueryHandler(IMapper mapper, IUnitOfWork unitOfWork)
    {
        _mapper = mapper;
        _unitOfWork = unitOfWork;
    }

    public async Task<PaginatedResult<GetSaleProductDto>> Handle(GetAllSaleProductQuery request, CancellationToken cancellationToken)
    {
