...
public class GetAllSalePaymentsQuery: IRequest<PaginatedResult<GetSalePaymentDto>>
{
    public int? SaleId { get; set; }
    public int PageNumber { get; set; }
    public int PageSize { get; set; }
}
internal class GetAllSalePaymentsQueryHandler : IRequestHandler<GetAllSalePaymentsQuery,PaginatedResult<GetSalePaymentDto>>
{
    private readonly IMapper _mapper;
    private readonly IUnitOfWork _unitOfWork;

    public GetAllSalePaymentsQueryHandler(IMapper mapper, IUnitOfWork unitOfWork)
    {
        _mapper = mapper;
        _unitOfWork = unitOfWork;
    }

    public async Task<PaginatedResult<GetSalePaymentDto>> Handle(GetAllSalePaymentsQuery request, CancellationToken cancellationToken)
    {
