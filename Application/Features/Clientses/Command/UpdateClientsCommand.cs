...
public class UpdateClientsCommand: IRequest<Result<Clients>>
{

    public int Id { get; set; }
    public CreateClientsCommand CreateCommand { get; set; } = new();

    public UpdateClientsCommand(int id, CreateClientsCommand createCommand)
    {
        Id = id;
        CreateCommand = createCommand;
    }
}
internal class UpdateClientsCommandHandler : IRequestHandler<UpdateClientsCommand, Result<Clients>>
{
    ...
    public async Task<Result<Clients>> Handle(UpdateClientsCommand request, CancellationToken cancellationToken)
    {
