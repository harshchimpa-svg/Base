...
public class GetAllDietQuery : IRequest<PaginatedResult<GetDietDto>>
{
    public int? DietTypeId { get; set; }
    public int PageNumber { get; set; }
    public int PageSize { get; set; }
}
internal class GetAllDietQueryHandler : IRequestHandler<GetAllDietQuery,PaginatedResult<GetDietDto>>
{
    private readonly IMapper _mapper;
    private readonly IUnitOfWork _unitOfWork;

    public GetAllDietQueryHandler(IMapper mapper, IUnitOfWork unitOfWork)
    {
        _mapper = mapper;
        _unitOfWork = unitOfWork;
    }

    public async Task<PaginatedResult<GetDietDto>> Handle(GetAllDietQuery request, CancellationToken cancellationToken)
    {
