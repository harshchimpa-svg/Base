...
internal class GetUserMembershipByIdQueryHandler : IRequestHandler<GetUserMembershipByIdQuery, Result<GetUserMembershipDto>>
{
    ...
    public async Task<Result<GetUserMembershipDto>> Handle(GetUserMembershipByIdQuery request, CancellationToken cancellationToken)
    {
