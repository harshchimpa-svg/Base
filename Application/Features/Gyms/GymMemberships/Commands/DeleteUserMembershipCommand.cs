...
internal class DeleteUserMembershipCommandHandler : IRequestHandler<DeleteUserMembershipCommand, Result<bool>>
{
    ...
    public async Task<Result<bool>> Handle(DeleteUserMembershipCommand request, CancellationToken cancellationToken)
    {
