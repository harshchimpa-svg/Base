...
public class GetAllEmployeeQuery: IRequest<PaginatedResult<GetUserDto>>
{
...
internal class GetAllEmployeeQueryHandler : IRequestHandler<GetAllEmployeeQuery, PaginatedResult<GetUserDto>>
{
    ...
    public async Task<PaginatedResult<GetUserDto>> Handle(GetAllEmployeeQuery request, CancellationToken cancellationToken)
    {
