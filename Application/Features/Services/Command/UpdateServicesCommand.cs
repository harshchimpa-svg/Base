...
public class UpdateServicesCommand: IRequest<Result<Service>>
{

    public int Id { get; set; }
    public CreateServiceCommand CreateCommand { get; set; } = new();

    public UpdateServicesCommand(int id, CreateServiceCommand createCommand)
    {
        Id = id;
        CreateCommand = createCommand;
    }
}
internal class UpdateServicesCommandHandler : IRequestHandler<UpdateServicesCommand, Result<Service>>
{
    ...
    public async Task<Result<Service>> Handle(UpdateServicesCommand request, CancellationToken cancellationToken)
    {
